...
TOOLS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Date inputs are SNAPPED to actual payout-cycle boundaries (payouts run on a fixed day each "
            "month, returned as `payout_day_of_month`). The response includes both `requested_window` "
